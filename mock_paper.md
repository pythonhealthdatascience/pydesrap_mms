...
![Figure A.1](outputs/choose_dist_iat_hist.png)

![Figure A.2](outputs/choose_dist_servelength_hist.png)
...
![Figure C.1](outputs/choose_reps_mean_q_time_nurse.png)

![Figure C.2](outputs/choose_reps_mean_time_with_nurse.png)

![Figure C.3](outputs/choose_reps_mean_nurse_utilisation.png)
