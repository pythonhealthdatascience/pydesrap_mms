...
class Model:
    ...
    def __init__(self, run_number):
        ...
        # Create list to store patient-level results
        self.results_list = []
        ...
        self.patient_inter_arrival_dist = Exponential(
            mean = g.patient_inter, random_seed = seeds[0])
        self.nurse_consult_time_dist = Exponential(
            mean = g.mean_n_consult_time, random_seed = seeds[1])
    ...
    def attend_clinic(self, patient):
        ...
        with self.nurse.request() as req:
            ...
            if self.env.now >= g.warm_up_period:
                ...
                self.results_list.append(patient_result)
    ...
    def calculate_run_results(self):
        self.mean_q_time_nurse = np.mean([result['q_time_nurse'] for result in self.results_list])
...
class Trial:
    ...
    def run_single(self, run):
        ...
        trial_results = {
            ...
            'mean_q_time_nurse': my_model.mean_q_time_nurse,
            'average_nurse_utilisation': my_model.nurse_utilisation
        }
...
interval_audits_median = my_trial.interval_audit_df.drop('resource_name', axis=1).groupby('simulation_time').median().reset_index()
...
display(pd.concat(results).drop('run', axis=1).groupby('scenario').mean().head(20))
