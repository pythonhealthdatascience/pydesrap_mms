...
class Model:
        ...
        with self.nurse.request() as req:
            ...
            if self.env.now > g.warm_up_period:
                patient_result = {
                    ...
                    'Time with Nurse': sampled_nurse_act_time
                }
    ...
    def interval_audit_utilisation(self, resources, interval=1):
        ...
        # TODO: Check if this prevents getting audit result at time 0
        while True:
            # Only save results if the warm up period has passed
            if self.env.now > g.warm_up_period:
    ...
    def calculate_run_results(self):
        self.mean_q_time_nurse = np.mean([result['Q Time Nurse'] for result in self.results_list])
