"""
Functional testing of objects used to determine number of replications.
"""
...
from simulation import (
    confidence_interval_method, confidence_interval_method_simple, Param,
    Runner, ReplicationsAlgorithm
)
